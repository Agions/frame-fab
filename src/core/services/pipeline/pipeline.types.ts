 ...
 *
 * 与核心 PipelineStatus 枚举的差异：
 * - 本类型使用 'error'，核心枚举使用 'failed'
 * - 本类型不含 'cancelled'
 *
 ...
 *
 * 核心版为 10 值枚举（额外包含 'video-editing' / 'composition' / 'audio-synthesis'）。
 *
 ...
 *
 * 核心版 PipelineContext 包含额外能力（getCheckpoint / saveCheckpoint / emit）。
 *
