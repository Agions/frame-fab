...
> frame-fab 通过**本地服务接口**暴露能力。本章节列出了 7 大核心服务的 API 参考。
...
- 阅读 [API 概述](./overview.md) 了解调用约定
- 查看 [架构设计](../developer-guide/architecture.md) 了解实现细节
- 查看 [快速开始](../getting-started/quick-start.md) 上手 3 步跑通
